...
export const Register = () => {
	const intl = useIntl();
	const [createUserWithEmailAndPassword, , loadingRegisterViaEmail, errorRegisterViaEmail] = useCreateUserWithEmailAndPassword(firebaseAuth);
	useHandleError(!loadingRegisterViaEmail && !!errorRegisterViaEmail, errorRegisterViaEmail?.message);
